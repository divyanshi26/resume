...
\begin{document}
    ...
    \skills
        {C\#, JavaScript, SQL, C++, Python, Java}  % Programming
        {ASP.NET, Angular, Flask, Ionic, ZeroMQ, numpy}  % Frameworks/Libraries
        {SQL Server, MySQL, Oracle, PostGIS}  % Databases
    ...
    % Accomplished [X] as measured by [Y], by doing [Z]
        ...
        \bulletsBegin
            \item Led the design, implementation and deployment of a robust internal control plane allowing external teams to invoke POST methods for resource creation and deletion leveraging API Gateway, Lambda and DynamoDB. Implemented authentication, unit tests and real-time monitoring, while driving cross-team integration testing and facilitating collaborative design discussions.
	    \vspace{-2pt}
